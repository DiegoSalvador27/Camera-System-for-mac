...
Diego_image = face_recognition.load_image_file("Diego.jpg")
Diego_face_encoding = face_recognition.face_encodings(Diego_image)[0]

# Load a second sample picture and learn how to recognise it.
...
known_face_names = [
    "Diego(OWNER)",
    "Charles(the_guy_that_MrHoffman_calles_whenever_he's_bored"
]
